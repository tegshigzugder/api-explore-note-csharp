...
public class ReviewController : ControllerBase
{
	...
	public IActionResult AddReview([FromRoute] int userId, [FromRoute] long placeId, [FromBody] PlaceReviewRequestDto placeRequestDto)
	{
	...
	public async Task<ActionResult<List<PlaceDetailsResponseDto>>> GetReview([FromRoute] int userId = 1, [FromRoute] long placeId = 1)
	{
